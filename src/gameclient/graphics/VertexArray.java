...
public class VertexArray {
    ...
    //vertex array object, vertex buffer object, index buffer object, texture buffer object
    ...
    public void changeBuffers(float[] vertices, byte[] indices, float[] textureCoordinates){
        count = indices.length;
